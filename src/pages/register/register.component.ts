    ...
    <div class="auth">
      <div class="auth-panel">
        ...
        <form (ngSubmit)="submit()" class="auth-form">
          ...
          <div class="password-wrapper">
            <input class="input password-input" [type]="showConfirmPassword ? 'text' : 'password'" name="confirm" [(ngModel)]="confirm" required placeholder="confirmar senha" />
            <button type="button" class="toggle-password-btn" (click)="showConfirmPassword = !showConfirmPassword" aria-label="Visualizar senha confirmada">
              <svg *ngIf="!showConfirmPassword" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
                <circle cx="12" cy="12" r="3"/>
              </svg>
              <svg *ngIf="showConfirmPassword" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
